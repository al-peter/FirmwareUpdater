/****************************************************************************
** Meta object code from reading C++ file 'firmwareupdater.h'
**
...
#error "The header file 'firmwareupdater.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 16, 14), // "updateFinished"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 7), // "success"
QT_MOC_LITERAL(4, 40, 7) // "message"

    },
    "FirmwareUpdater\0updateFinished\0\0success\0"
    "message"
};
...
void FirmwareUpdater::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateFinished((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FirmwareUpdater::*)(bool , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FirmwareUpdater::updateFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FirmwareUpdater::updateFinished(bool _t1, const QString & _t2)
{
